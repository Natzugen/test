...
void ConnectEx::EnableAutoReconect()
{
	g_AutoReconnect = GetPrivateProfileInt("Connect", "IsAutoReconnect", 0, gDirPath.GetNewPath("Custom\\AutoReconnect.ini"));
	g_AutoBotStart = GetPrivateProfileInt("Connect", "MuHelperAutoStart", 0, gDirPath.GetNewPath("Custom\\AutoReconnect.ini"));
}