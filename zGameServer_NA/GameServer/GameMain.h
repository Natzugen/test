...
extern int g_AutoBotStart;

extern BYTE g_MuHelperMinLevel;

#ifdef NEWVIPSYSTEM
extern int g_isCustomVipSys;
extern int g_vip1AddExp;
extern int g_vip2AddExp;
extern int g_vip3AddExp;
extern int g_vip4AddExp;
extern int g_vip5AddExp;
extern int g_vip6AddExp;

extern int g_vip1AddDrop;
extern int g_vip2AddDrop;
extern int g_vip3AddDrop;
extern int g_vip4AddDrop;
extern int g_vip5AddDrop;
extern int g_vip6AddDrop;

extern int g_Buyvip1ItemCode;
extern int g_Buyvip2ItemCode;
extern int g_Buyvip3ItemCode;
extern int g_Buyvip4ItemCode;
extern int g_Buyvip5ItemCode;
extern int g_Buyvip6ItemCode;
#endif
...
extern char g_ConnectMemberFile[300];
extern DWORD g_isUpdateVipStatus;
...
//GXPROTECT SERVEr
extern BOOL g_GXProtectConnection;
//END
